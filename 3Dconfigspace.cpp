...
void DrawRectangleWhite(cv::Mat& image, cv::Point centerPoint, cv::Size rectangleSize, int rotationDegrees)
{
...
void DrawRectangleBlue(cv::Mat& image, cv::Point centerPoint, cv::Size rectangleSize, int rotationDegrees)
{
